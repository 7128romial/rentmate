...
const RENTER_ITEMS = [
  ...
  { key: 'matches', href: '/matches.html', label: 'התאמות', icon: HEART_ICON },
  { key: 'profile', href: '/profile.html', label: 'פרופיל', icon: USER_ICON },
];

const LANDLORD_ITEMS = [
  { key: 'landlord', href: '/landlord.html', label: 'הדירות שלי', icon: GRID_ICON },
  { key: 'inquiries', href: '/landlord_inquiries.html', label: 'פניות', icon: INBOX_ICON },
  { key: 'profile', href: '/profile.html', label: 'פרופיל', icon: USER_ICON },
];
